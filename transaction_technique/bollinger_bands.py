...
def set_bollinger_bands(coin_df_origin, ma = 20, std = 2):
  ...
  bol = BollingerBands(result['trade_price'], window=bol_ma, window_dev=bol_std_multiplier)

  bol_middle_band = bol.bollinger_mavg()
  bol_upper_band = bol.bollinger_hband()
  bol_lower_band = bol.bollinger_lband()
